...
export function AreasList({ areas, onAreaClick }: AreasListProps) {
  return (
    <div style={styles.container}>
      ...
      <div style={styles.areasList}>
        {areas.map(area => {
          const filledCount = area.locations.filter(loc => loc.assignedPuzzleId).length;
          ...
          return (
            ...
            >
              ...
              <div style={styles.areaInfo}>
                <span style={styles.areaLetters}>{area.letterCount} letters</span>
                <span style={styles.areaDot}>•</span>
                <span style={styles.areaProgress}>{filledCount}/{totalCount} locations</span>
              </div>
